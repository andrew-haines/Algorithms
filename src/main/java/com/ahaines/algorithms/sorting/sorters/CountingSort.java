 ...
 * we have the number of occurrences of it but also the number of values we have seen that have a lower value then the bucket we are looking at
 ...
 * conversion would need to be performed to accurately represent this), requires some knowledge of the input set (ie the range each input can take). Typically
...
public class CountingSort extends Sorter<Integer> {
	...
	public String toString(){
		return super.toString() +": range("+inputRange+")";
	}
